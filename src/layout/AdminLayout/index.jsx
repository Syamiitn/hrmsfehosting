...
export default function HrLayout() {
    ...
    let shouldShowSidebar =location.pathname !=="/admin/globalsettings"

    return (
        <div className={!shouldShowSidebar ? "global-layout flex-1 " :"employee-layout flex"}>
            {/* Sidebar (left) */}
            {shouldShowSidebar &&  
               <Sidebar
            ...
            <div className="flex flex-col flex-1">
                ...
                <main  className={shouldShowSidebar ? "flex-1 min-h-[80vh] max-h-[90vh] overflow-y-auto px-4" :" "} >
                    <Outlet />
                </main>
            </div>
        </div>
